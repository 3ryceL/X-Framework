...
RegisterNetEvent('x-radialmenu:ResetClothing')
AddEventHandler('x-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('x-radialmenu:ToggleClothing')
AddEventHandler('x-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('x-radialmenu:ToggleProps')
AddEventHandler('x-radialmenu:ToggleProps', ToggleProps)
...
function Notify(message, color) -- However you want your notifications to be shown, you can switch it up here.
	XCore.Functions.Notify(message, color)
end
