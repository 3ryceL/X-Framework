                ...
                if dist < 10 then
                    ...
                    if dist < 1 then
                        ...
                        if IsControlJustPressed(0, 38) then -- E
                            ...
                            local ShopItems = {}
                            ShopItems.items = {}
                            XCore.Functions.TriggerCallback('x-shops:server:getLicenseStatus', function(result)
...
RegisterNetEvent('x-shops:client:UpdateShop')
AddEventHandler('x-shops:client:UpdateShop', function(shop, itemData, amount)
    TriggerServerEvent('x-shops:server:UpdateShopItems', shop, itemData, amount)
end)

RegisterNetEvent('x-shops:client:SetShopItems')
AddEventHandler('x-shops:client:SetShopItems', function(shop, shopProducts)
    Config.Locations[shop]["products"] = shopProducts
end)

RegisterNetEvent('x-shops:client:RestockShopItems')
AddEventHandler('x-shops:client:RestockShopItems', function(shop, amount)
