...
AddEventHandler('XCore:NotifyClient:OnPlayerLoaded', function()
    ...
    onDuty = XCore.Functions.GetPlayerData().job.onduty
    isHandcuffed = false
    TriggerServerEvent("XCore:NotifyServer:SetMetaData", "ishandcuffed", false)
    ...
    if XCore.Functions.GetPlayerData().metadata["tracker"] then
        ...
        TriggerEvent('x-clothing:client:loadOutfit', trackerClothingData)
    else
...
AddEventHandler('police:client:SendPoliceEmergencyAlert', function()
    ...
    TriggerServerEvent("police:server:SendPoliceEmergencyAlert", streetLabel, pos, XCore.Functions.GetPlayerData().metadata["callsign"])
    TriggerServerEvent('x-policealerts:server:AddPoliceAlert', {
        timeOut = 10000,
        ...
        details = {
            [1] = {
                ...
                detail = MyId .. ' | ' .. XCore.Functions.GetPlayerData().charinfo.firstname .. ' ' .. XCore.Functions.GetPlayerData().charinfo.lastname,
            },
            [2] = {
