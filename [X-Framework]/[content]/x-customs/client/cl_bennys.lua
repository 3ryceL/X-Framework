...
local function saveVehicle()
	...
	local myCar = XCore.Functions.GetVehicleProperties(veh)
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("x-customs:attemptPurchase", type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("x-customs:purchaseSuccessful")
AddEventHandler("x-customs:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    XCore.Functions.Notify("Purchase Successful")
end)

RegisterNetEvent("x-customs:purchaseFailed")
AddEventHandler("x-customs:purchaseFailed", function()
    isPurchaseSuccessful = false
    attemptingPurchase = false
    XCore.Functions.Notify("Not enough money", "error")
end)
