...
XCore.Functions.CreateCallback('x-anticheat:server:GetPermissions', function(source, cb)
...
RegisterServerEvent('x-anticheat:server:banPlayer')
AddEventHandler('x-anticheat:server:banPlayer', function(reason)
    local src = source
    TriggerEvent("x-log:server:CreateLog", "anticheat", "Anti-Cheat", "white", GetPlayerName(src).." Has Been Banned For "..reason, false)
...
function NonRegisteredEventCalled(CalledEvent, source)
    TriggerClientEvent("x-anticheat:client:NonRegisteredEventCalled", source, "Cheating", CalledEvent)
end
...
XCore.Functions.CreateCallback('x-anticheat:server:HasWeaponInInventory', function(source, cb, WeaponInfo)
    local src = source
