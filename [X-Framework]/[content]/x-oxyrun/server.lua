...
AddEventHandler('oxydelivery:receiveBigRewarditem', function()
	...
	TriggerClientEvent('inventory:client:ItemBox', source, XCore.Shared.Items[Config.BigRewarditem], "add")
end)
...
AddEventHandler('oxydelivery:receiveoxy', function()
	...
	TriggerClientEvent('inventory:client:ItemBox', source, XCore.Shared.Items[Config.Item], "add")
end)
