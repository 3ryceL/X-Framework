# x-houses
Real Estate for X-Core Framework :house_with_garden:

## Dependencies
- [x-core](https://github.com/xcore-framework/x-core)
- [x-radialmenu](https://github.com/xcore-framework/x-radialmenu) - For the menu in screenshots
- [x-anticheat](https://github.com/xcore-framework/x-anticheat) - Anti Cheat 
- [x-phone](https://github.com/xcore-framework/x-phone) - Houses app
- [x-multicharacter](https://github.com/xcore-framework/x-multicharacter) - Checking if player is inside after character chosen (You need to edit the lines if you don't use this)
- [x-garages](https://github.com/xcore-framework/x-garages) - House Garage
- [x-interior](https://github.com/xcore-framework/x-interior) - Necessary for house interiors
- [x-clothing](https://github.com/xcore-framework/x-clothing) - Outfits
- [x-weathersync](https://github.com/xcore-framework/x-weathersync) - Desync weather inside house
- [x-weed](https://github.com/xcore-framework/x-weed) - Weed plant
- [x-skillbar](https://github.com/xcore-framework/x-skillbar) - Skills
...
- Import `x-houses.sql` in your database
