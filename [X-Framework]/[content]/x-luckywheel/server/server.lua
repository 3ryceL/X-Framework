...
RegisterServerEvent('x-luckywheel:getLucky')
AddEventHandler('x-luckywheel:getLucky', function()
    local _source = source
    local xPlayer = XCore.Functions.GetPlayer(_source)
    if not isRoll then
        if xPlayer ~= nil then
            ...
            if chips ~= nil and chips.amount >= amount then
                ...
                SetTimeout(12000, function()
                    ...
                    if _priceIndex == 1 or _priceIndex == 9 or _priceIndex == 13 or _priceIndex == 17 then
                        ...
                        TriggerClientEvent('XCore:Notify', _source, 'You Won 25,000 Casino Chips!', 'success')
                    elseif _priceIndex == 2 or _priceIndex == 6 or _priceIndex == 10 or _priceIndex == 14 or _priceIndex == 18 then
                        ...
                        TriggerClientEvent('XCore:Notify', _source, 'You Won....Sandwich and Water?', 'success')
                    elseif _priceIndex == 3 or _priceIndex == 7 or _priceIndex == 15 or _priceIndex == 20 then
                        ...
                        TriggerClientEvent('XCore:Notify', _source, 'You Won $'.._money..'!', 'success')
                    elseif _priceIndex == 4 or _priceIndex == 8 or _priceIndex == 11 or _priceIndex == 16 then
                        ...
                        TriggerClientEvent('XCore:Notify', _source, 'You Won Marked Bills!', 'success')
                    elseif _priceIndex == 5 then
                        -- print("Win 300,000$")
                        xPlayer.Functions.AddMoney('cash', 300000)
                        TriggerClientEvent('XCore:Notify', _source, 'You Won $300,000 Cash!', 'success')
                    elseif _priceIndex == 12 then
                        -- print("Win ak gold")
                        xPlayer.Functions.AddItem("weapon_pistol50", 1)
                        TriggerClientEvent('XCore:Notify', _source, 'You Won A .50 Pistol!', 'success')
                    elseif _priceIndex == 19 then
                        -- print("Win car lp700r")
                        TriggerClientEvent("x-luckywheel:winCar", _source)
                        TriggerClientEvent('XCore:Notify', _source, 'You Won A Fucking Car!', 'success')
                    end
                    TriggerClientEvent("x-luckywheel:rollFinished", -1)
                end)
                TriggerClientEvent("x-luckywheel:doRoll", -1, _priceIndex)
            else
                TriggerClientEvent("x-luckywheel:rollFinished", -1)    
                TriggerClientEvent('XCore:Notify', _source, 'You Need 50,000 Chips To Spin!', 'error')
            end
        end
    end
end)
