            ...
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        ...
                        X.Phone.Notifications.Add("fas fa-phone", "Phone", "You are already connected to a call!");
                    }
                } else {
                    X.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is already in a call");
                }
            } else {
