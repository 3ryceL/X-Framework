...
XCore.Functions.CreateCallback('x-hotdogjob:server:HasMoney', function(source, cb)
...
XCore.Functions.CreateCallback('x-hotdogjob:server:BringBack', function(source, cb)
    local Player = XCore.Functions.GetPlayer(source)
...
RegisterServerEvent('x-hotdogjob:server:Sell')
AddEventHandler('x-hotdogjob:server:Sell', function(Amount, Price)
    local src = source
...
RegisterServerEvent('x-hotdogjob:server:UpdateReputation')
AddEventHandler('x-hotdogjob:server:UpdateReputation', function(quality)
    local src = source
    local Player = XCore.Functions.GetPlayer(src)
    ...
    if Reset then
        ...
        TriggerClientEvent('x-hotdogjob:client:UpdateReputation', src, JobReputation)
        return
    end
...
XCore.Commands.Add("removestand", "Delete Stand (Admin Only)", {}, false, function(source, args)
    TriggerClientEvent('x-hotdogjob:staff:DeletStand', source)
end, 'admin')