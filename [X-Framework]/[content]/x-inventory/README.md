...
- [x-logs](https://github.com/xcore-framework/x-logs) - For logging transfer and other history
- [x-traphouse](https://github.com/xcore-framework/x-traphouse) - Trap house system for xcore
- [rp-radio](https://github.com/xcore-framework/rp-radio) - Radio system for communication
- [x-drugs](https://github.com/xcore-framework/x-drugs) -  Drugs and weeds system
- [x-shops](https://github.com/xcore-framework/x-shops) - Needed in order to add shops
...
- Import `x-inventory.sql` in your database
