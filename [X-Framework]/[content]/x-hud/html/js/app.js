...
(() => {
    ...
    XHud.ToggleSeatbelt = function(data) {
        if (data.seatbelt) {
    ...
    XHud.ToggleCruise = function(data) {
        if (data.cruise) {
    ...
    window.onload = function(e) {
        window.addEventListener('message', function(event) {
            switch(event.data.action) {
                case "open":
                    XHud.Open(event.data);
                    break;
                case "close":
                    XHud.Close();
                    break;
                case "update":
                    XHud.Update(event.data);
                    break;
                case "show":
                    XHud.Show(event.data);
                    break;
                case "hudtick":
                    XHud.UpdateHud(event.data);
                    break;
                case "car":
                    XHud.CarHud(event.data);
                    break;
                case "seatbelt":
                    XHud.ToggleSeatbelt(event.data);
                    break;
                case "cruise":
                    XHud.ToggleCruise(event.data);
                    break;
            }
        })
    }
