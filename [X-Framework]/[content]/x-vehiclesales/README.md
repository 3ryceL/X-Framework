# x-vehiclesales
Used Car Sale for X-Core Framework :blue_car:

## Dependencies
- [x-core](https://github.com/xcore-framework/x-core)
- [x-garages](https://github.com/xcore-framework/x-garages) - Vehicle ownership
- [x-phone](https://github.com/xcore-framework/x-phone) - For the e-mail
- [x-logs](https://github.com/xcore-framework/x-logs) - Keep event logs
...
- Import `x-vehiclesales.sql` in your database
...
ensure x-vehiclesales
```

## Configuration
- To adjust tax, go to x-vehiclesales\server\main.lua row 85 and change "77" to your liking
```
Config = Config or {}
