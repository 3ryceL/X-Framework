RegisterServerEvent('XCore:NotifyDebugSomething')
AddEventHandler('XCore:NotifyDebugSomething', function(resource, obj, depth)
...
XCore.Debug = function(resource, obj, depth)
    TriggerEvent('XCore:NotifyDebugSomething', resource, obj, depth)
end

XCore.ShowError = function(resource, msg)
    print("\x1b[31m["..resource..":ERROR]\x1b[0m "..msg)
end

XCore.ShowSuccess = function(resource, msg)
